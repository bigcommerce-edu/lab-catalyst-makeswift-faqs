...
Copy the _catalyst-start_ branch.
...
Copy the _makeswift-start_ branch.
...
[Full Lab 3 diff](https://github.com/bigcommerce-edu/lab-catalyst-makeswift-faqs/compare/makeswift-faqs-start...makeswift-faqs-complete?diff=split)
